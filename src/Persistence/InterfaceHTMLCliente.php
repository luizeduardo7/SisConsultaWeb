...
class InterfaceHTMLCliente{
    ...
    function Operacao(){
        echo "<!DOCTYPE html><html><head>
            ...
            <body>
                <div class='container'>
                    <a class='linkInicio' href='../View/Clientes.html'> Voltar</a><br>
                <div class='box'>
    ...
    function ExibirTabela($res){
        echo "<!DOCTYPE html><html><head>
            ...
            <body>
                <div class='container'>
                    <br><a class='linkInicio' href='../View/Clientes.html'> Voltar</a><br><br>
                <div class='box'>
                    <table>
                        <tr>
                            <th>CPF</th>
    ...
    function ConfirmeAlterar($res){
        ...
        echo "<!DOCTYPE html><html><head><meta charset='UTF-8'>
            ...
            <div class='container'>
                ...
                <form action='..\Controller\AlterarClienteDefinitivo.php' method='POST'>
                    CPF: <input type='text' readonly name='ccpf' value='".$registro['CPF']."' required><br>
        ...
        echo "<!DOCTYPE html><html><head><meta charset='UTF-8'>
            ...
            <div class='container'>
                ...
                <div class='box'>
                    ...
                    <form action='..\Controller\ExcluirDefinitivo.php' method='POST'>
                        CPF: <input type='text' readonly name='ccpf' value='".$registro['CPF']."' required><br>
